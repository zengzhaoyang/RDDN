...
class ToDataContainer(object):
    ...
    def __init__(self,
                 fields=(dict(key='img', stack=True), dict(key='gt_bboxes'),
                         dict(key='gt_labels'), dict(key='template', stack=True))):
        self.fields = fields
